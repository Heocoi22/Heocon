...
datapath_m =  '.\\Data_m\\'
 #---------------------------------------------------------------------------------------------------------------------
db_start_time = datetime.datetime(2022,11,1,0,0)      #Set time begin(yyyy,mm,dd,hh,mm)
db_end_time = datetime.datetime(2022,11,30,23,59) 
#---------------------------------------------------------------------------------------------------------------------
...
Model_list = ['CGNV5_TF2','CGNV5_CLR']
